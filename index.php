    ...
    <div class="max-w-md mx-auto">
        <form method="post"  class="bg-white p-4 rounded shadow-md">
          <div class="mb-4">
            ...
            <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="num1" type="number" name="num1" required>
          </div>
          <div class="mb-4">
            <label class="block text-gray-700 font-bold mb-2" for="num2">
              Second number:
            </label>
            <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="num2" type="number" name="num2" required>
          </div>
          <div class="mb-4">
        ...
        <div class="rounded w-full py-2 px-3 text-gray-700 text-xl focus:outline-none focus:shadow-outline" value="result"></div>
      </div>
